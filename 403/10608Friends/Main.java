...
class Main{
   ...
   static int calculateNumOfPeople(int startIndex, int endIndex, ArrayList<Integer> input, int numOfCitizens) {
       ...
       for (int i=startIndex; i<endIndex; i+=2) {
           ...
           if (citizenConnectionValues[a] ==0 && citizenConnectionValues[b] ==0) {
           ...
           else if ((citizenConnectionValues[a] !=0 && citizenConnectionValues[b] !=0) &&  (citizenConnectionValues[b] != citizenConnectionValues[a])) {
               ...
               if (indexOfA < indexOfB) {
                   citizenConnectionValues = updateIndices(stackOfB,citizenConnectionValues, indexOfA-1);
                   allStacks.set(indexOfA-1,merge(stackOfA, stackOfB));
               ...
               //if indexOfB < indexOfA, merge A onto B, then update value of A
                   ...
                   allStacks.set(indexOfB, stackOfB);
       ...
       int count = allStacks.get(0).size();
